...
\begin{figure}
    ...
    \caption{Comparison of compression of semantic objects in standard \textsc{jpeg}[left] and our model [right]\label{fig_compressing_demo}}
\end{figure}
...
\begin{figure}
    ...
    \caption{Comparison of various methods of detecting objects in an image \label{fig_comparison_of_map}}
\end{figure}
...
\begin{figure}
    ...
    \caption{Sample of our map for five KODAK images.\label{fig_kodak_combo}}
\end{figure}
...
Our model & 39.6  & 28.67  & 34.63 & 44.89     & 0.915 & 0.991 & 0.522     \\
			  \toprule
\end{tabular}
\caption{Results across datasets \label{tbl_results}}
\end{table}
        
\begin{figure}
    \centering
    \includegraphics[scale=0.23]{figures/semantic/image_size.pdf}
    \caption{\texttt{PSNR-HVS} of our model - \textsc{jpeg} across various image size (higher is better). \label{fig_size}}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[scale=0.23]{figures/semantic/image_mit.pdf}
    \caption{\texttt{PSNR-HVS} of our model - \textsc{jpeg} across various categories of MIT Saliency dataset (higher is better). \label{fig_mit}}
\end{figure}
